    ...
    public static function getColumns(): array
    {
        return [
            ExportColumn::make('id')
                ->label('ID'),
            ExportColumn::make('duration_id'),
            ExportColumn::make('course_category_id'),
            ExportColumn::make('course_type_id'),
            ExportColumn::make('name'),
            ExportColumn::make('course_code'),
            ExportColumn::make('total_fee'),
            ExportColumn::make('eligibility'),
            ExportColumn::make('course_duration'),
            ExportColumn::make('other_details'),
